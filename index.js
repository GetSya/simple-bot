...
•🔗 Link Channel : ${yut.all[0].author.url}`      
        ...
        py =await syaa..prepareMessage(from, ya, image)
        gbutsan = [{buttonId: `${prefix}ytmp3 ${yut.all[0].url}`, buttonText: {displayText: 'Audio/Mp3'}, type: 1},{buttonId: `${prefix}ytmp4 ${yut.all[0].url}`, buttonText: {displayText: 'Video/Mp4'}, type: 1}]
        gbuttonan = {
        ...
        await syaa..sendMessage(from, gbuttonan, MessageType.buttonsMessage)})
        break                
case 'ytmp3':
  if (!isRegistered) return sendButRegis(from, daftar1, daftar2, daftar3, { quoted:mek})
