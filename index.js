...
◩ *© Jojo-Bot* ◩`
  sendButMessage(from, menu2, `Simple Bot By @sofunsyabi.id`, [
        ...
        break;
        case 'sc':
          reply(`👇${readmore}https://github.com/GetSya/JojoRepo`)
          break
//random
case 'waifu':
      case 'loli':
      ...
      case 'wallpaperanime':
        let wipu = await fetchJson(
          `https://hardianto.xyz/api/search/pinterest?query=${command}&apikey=hardianto`
        );
...
case 'grupjojo':
  ...
  sendButMessage(from, anu.result.text_id, "Keren kali ye", [
          {
            buttonId: `quote`,
            buttonText: {
